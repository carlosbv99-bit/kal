...
Licencia: [Apache 2.0](LICENSE). Las skills de referencia incluidas en
este repo (`skills/`) quedan bajo la misma licencia — un autor externo
que publique su propia skill en otro repositorio elige su propia
licencia, esto no lo condiciona.
